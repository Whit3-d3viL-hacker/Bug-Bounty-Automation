This recon.py tool automates the first step in bug bounty hunting. It finds all subdomains, identifies live subdomains, retrieves waybackurls, and captures screenshots of live subdomains.
